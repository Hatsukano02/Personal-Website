...
export interface ApiAlbumAlbum extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    apple_music_url: Schema.Attribute.String;
    artist: Schema.Attribute.String & Schema.Attribute.Required;
    cover_image: Schema.Attribute.Media<'images'>;
    cover_video: Schema.Attribute.Media<'videos'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiBlogPostBlogPost extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    featured_audio: Schema.Attribute.Media<'audios'>;
    featured_image: Schema.Attribute.Media<'images'>;
    featured_video: Schema.Attribute.Media<'videos'>;
...
export interface ApiMediaWorkMediaWork extends Struct.CollectionTypeSchema {
  collectionName: 'media_works';
  info: {
    description: '\u5F71\u89C6\u52A8\u753B\u4F5C\u54C1\u8BB0\u5F55';
    displayName: 'Media Work';
    pluralName: 'media-works';
    singularName: 'media-work';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    bangumi_url: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    display_order: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<0>;
    douban_url: Schema.Attribute.String;
    genre: Schema.Attribute.JSON;
    imdb_url: Schema.Attribute.String;
    is_favorite: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    personal_rating: Schema.Attribute.Decimal &
      Schema.Attribute.SetMinMax<
        ...
        number
      >;
    poster_image: Schema.Attribute.Media<'images'>;
    publishedAt: Schema.Attribute.DateTime;
    release_year: Schema.Attribute.Integer;
    review: Schema.Attribute.Blocks;
    soundtrack_audio: Schema.Attribute.Media<'audios'>;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    trailer_url: Schema.Attribute.String;
    trailer_video: Schema.Attribute.Media<'videos'>;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    watch_date: Schema.Attribute.Date;
    watch_platform: Schema.Attribute.String;
    watch_status: Schema.Attribute.Enumeration<
      ['Watched', 'Watching', 'Plan_to_Watch']
    > &
      Schema.Attribute.DefaultTo<'Plan_to_Watch'>;
  };
}
...
export interface ApiPhotoAlbumPhotoAlbum extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    album_name: Schema.Attribute.String & Schema.Attribute.Required;
    album_type: Schema.Attribute.Enumeration<
      ['Travel', 'Portrait', 'Street', 'Commercial', 'Personal', 'Other']
    >;
    cover_photo: Schema.Attribute.Relation<'manyToOne', 'api::photo.photo'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    publishedAt: Schema.Attribute.DateTime;
    shoot_date: Schema.Attribute.Date;
    slug: Schema.Attribute.UID<'album_name'> & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiPhotoPhoto extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    camera_model: Schema.Attribute.String;
    category: Schema.Attribute.Enumeration<
      ['Portrait', 'Landscape', 'Street', 'Architecture', 'Nature', 'Other']
    > &
      Schema.Attribute.Required;
    color_space: Schema.Attribute.Enumeration<
      ['sRGB', 'Adobe_RGB', 'ProPhoto_RGB', 'DCI_P3']
    > &
      Schema.Attribute.DefaultTo<'sRGB'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
    display_order: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<0>;
    focal_length: Schema.Attribute.String;
    image: Schema.Attribute.Media<'images'> & Schema.Attribute.Required;
    is_featured: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    is_hdr: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    iso: Schema.Attribute.Integer;
    lens_model: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::photo.photo'> &
      Schema.Attribute.Private;
    location: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    shutter_speed: Schema.Attribute.String;
    slug: Schema.Attribute.UID<'title'> & Schema.Attribute.Required;
...
export interface ApiSocialLinkSocialLink extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    platform: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    platform_icon: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::media-work.media-work': ApiMediaWorkMediaWork;
