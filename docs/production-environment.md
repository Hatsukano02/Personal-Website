...
#### 站点配置 `/etc/nginx/sites-available/personal-site`
```nginx
server {
    listen 80;
    server_name _;
...
### 开发环境安全警告
- **esbuild <=0.24.2 漏洞**: 仅影响开发环境，生产环境安全
- **状态**: 可接受风险，Strapi团队后续版本将修复

### 版本兼容性
- **Strapi 5.x**: API结构相比4.x有变化，文档已更新
- **Tailwind CSS 4.x**: 支持新语法，配置已优化
- **React 19**: 生态系统稳定，性能提升明显
